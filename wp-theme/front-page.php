...
<main>
    <section class="hero">
        <div class="bg" style="background-image: url('https://via.placeholder.com/1920x1080');"></div>
        ...
        <div class="u-container content">
            ...
            <div class="stats">
                <div class="stat"><div class="number">100+</div><div class="label">Empresas confían</div></div>
                <div class="stat"><div class="number">100%</div><div class="label">Orgánico</div></div>
                <div class="stat"><div class="number">Local</div><div class="label">Pudahuel, RM</div></div>
            </div>
        </div>
    </section>
