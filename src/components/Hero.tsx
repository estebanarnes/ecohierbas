...
const Hero = () => {
  return <section className="relative min-h-[calc(100vh+10px)] flex items-center overflow-hidden" style={{backgroundImage: `url(${heroImage})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
