...
const ReviewsSection = () => {
  return (
    <section className="py-20 bg-muted/20" data-section="reviews">
      <div className="u-container">
        ...
        <div className="u-grid u-grid--cols-3 gap-8 mb-12">
          {reviews.map((review) => (
            <Card 
              key={review.id}
              className="bg-white border-border/50 hover:border-primary/20 transition-all duration-300 hover:shadow-md"
            >
